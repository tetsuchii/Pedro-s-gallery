...
export class UserImagesComponent implements OnInit {
  ...
  owner: string | undefined; //A felhasznalo id-ja, akinek a kepeit mutatja epp
  ...
  ownername: any; //A felhasznalo username-je, akinek a kepeit mutatja
  ...
  //Beallitja az adott felhasznalo idjat, majd username-jet, es kikeresi a hozza tartozo kepeket
  ngOnInit(): void {
    this.owner=this.flickrService.prevOwner;
    lastValueFrom(this.flickrService.search_owner(<string>this.flickrService.prevOwner))
    .then(res => {
      this.images = res;
    });
...
//Az adott felhasznalo kedvenceknek jelolt kepeit tolti be
